<div class="main-panel">
    <div class="content-wrapper pb-0">
        <div class="page-header flex-wrap">
            <h3 class="mb-0"> Hi, welcome back! <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block">Africa Gigs Link Admin.</span>
            </h3>
            <div class="d-flex">
                            ...
                            <div class="card-body px-3 py-4">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="color-card">
                                        ...
                                        <h2 class="text-white"> KES 8,753.<span class="h5">00</span>
                                        </h2>
                                    </div>
                            ...
                            <div class="card-body px-3 py-4">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="color-card">
                                        ...
                                        <h2 class="text-white"> KES 5,300.<span class="h5">00</span>
                                        </h2>
                                    </div>
                            ...
                            <div class="card-body px-3 py-4">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="color-card">
                                        ...
                                        <h2 class="text-white"> KES 1,753.<span class="h5">00</span>
                                        </h2>
                                    </div>
                    ...
                    <div class="card-body">
                                ...
                                <div class="card mb-3 mb-sm-0">
                                    <div class="card-body py-3 px-4">
                                        ...
                                        <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                                            <div>
                                                <h3 class="m-0 survey-value">KES 5,300</h3>
                            ...
                            <div class="col-sm-4">
                                <div class="card mb-3 mb-sm-0">
                                    <div class="card-body py-3 px-4">
                                        ...
                                        <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                                            <div>
                                                <h3 class="m-0 survey-value">KES 9,100</h3>
                            ...
                            <div class="col-sm-4">
                                <div class="card">
                                    <div class="card-body py-3 px-4">
                                        ...
                                        <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                                            <div>
                                                <h3 class="m-0 survey-value">KES 4,354</h3>
                                                <p class="text-success m-0">-310 avg. sales</p>
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <h5 class="d-inline-block survey-value mb-0"> KES 2,45,500 </h5>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                @foreach($transaction as $key => $t)
                                    @if($key >= count($transaction) - 10)
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="table-user-name ml-3">
                                                        <p class="mb-0 font-weight-medium"> {{$t->job_id}} </p>
                                            ...
                                            <td>
                                                <div class="badge badge-inverse-success"> {{$t->status}} </div>
                                            </td>
                                            <td>KES {{$t->calculated_column}}</td>
                                        </tr>
                                    @endif
                                @endforeach
                                </tbody>
